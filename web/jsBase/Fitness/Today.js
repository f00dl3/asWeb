...
function fitnessToday(dataIn) {
    ...
    var studChecked, commonRouteChecked, runWalk, cycling, rsMile, weight, shoe, mowNotes, xTags, hSleep, xOrgs, steps, calsBurned, exMins;
    ...
    var tableData = "<table><tbody>" +
            ...
            "<tr><td>Steps</td><td><input type='number' step='1' name='TodaySteps' value='" + steps + "'/></td></tr>" +
            "<tr><td>Burned Cals</td><td><input type='number' step='1' name='TodayCaloriesBurned' value='" + calsBurned + "'/></td></tr>" +
