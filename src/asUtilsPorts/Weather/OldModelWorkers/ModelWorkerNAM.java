...
public class ModelWorkerNAM {
	...
	public void main(String getHour, String round) {
		...
		final String namBase = modelBeans.getNomadsBase() + "/nam/prod/nam."+getDate;
		...
		try ( ResultSet resultSetNFH = wc.q2rs1c(dbc, nFHq, null); ) { 
		...
		for (String tFHourStr : nFHList) {
			...
			File sounding = new File(xml2Path.getPath()+"/outNAM_"+tFHour4D+".csv");
			File tFHGlob = new File(xml2Path.getPath()+"/fn"+tFHour4D);
			File tFHCtlFile = new File(tFHGlob.getPath()+".ctl");
			String tFHData = namBase+"/nam.t"+getHour+"z.conusnest.hiresf"+tFHour2D+".tm00.grib2";
			...
			Scanner namScanner = null; try {		
				...
				while(namScanner.hasNext()) {
					String line = namScanner.nextLine();
					...
					if(line.startsWith("62.1:")) { String[] lineTmp = line.split(","); try { tWU0 = Double.parseDouble(lineTmp[gribSpot].replace("val=", "")); } catch (ArrayIndexOutOfBoundsException aix) { aix.printStackTrace(); } }
					...
					if(line.startsWith("62.2:")) { String[] lineTmp = line.split(","); try { tWV0 = Double.parseDouble(lineTmp[gribSpot].replace("val=", "")); } catch (ArrayIndexOutOfBoundsException aix) { aix.printStackTrace(); } }
		
					if(line.startsWith("63:")) { String[] lineTmp = line.split(","); try { tCAPE = Double.parseDouble(lineTmp[gribSpot].replace("val=", "")); } catch (ArrayIndexOutOfBoundsException aix) { aix.printStackTrace(); } }
					if(line.startsWith("64:")) { String[] lineTmp = line.split(","); try { tCIN = Double.parseDouble(lineTmp[gribSpot].replace("val=", "")); } catch (ArrayIndexOutOfBoundsException aix) { aix.printStackTrace(); } }
					if(line.startsWith("67:")) { String[] lineTmp = line.split(","); try { tPRATE = Double.parseDouble(lineTmp[gribSpot].replace("val=", "")); } catch (ArrayIndexOutOfBoundsException aix) { aix.printStackTrace(); } }
					if(line.startsWith("65:")) { String[] lineTmp = line.split(","); try { tPWAT = Double.parseDouble(lineTmp[gribSpot].replace("val=", "")); } catch (ArrayIndexOutOfBoundsException aix) { aix.printStackTrace(); } }
					if(line.startsWith("25:")) { String[] lineTmp = line.split(","); try { tHGT500 = Double.parseDouble(lineTmp[gribSpot].replace("val=", "")); } catch (ArrayIndexOutOfBoundsException aix) { aix.printStackTrace(); } }
					if(line.startsWith("66")) { String[] lineTmp = line.split(","); try { tLI = Double.parseDouble(lineTmp[gribSpot].replace("val=", "")); } catch (ArrayIndexOutOfBoundsException aix) { aix.printStackTrace(); } }
			...
			if(tTC100 != 0.0001) { namJSON.put("T100_"+tFHour, tTC100); }
			if(tTC150 != 0.0001) { namJSON.put("T150_"+tFHour, tTC150); }
			if(tTC200 != 0.0001) { namJSON.put("T200_"+tFHour, tTC200); }
			if(tTC250 != 0.0001) { namJSON.put("T250_"+tFHour, tTC250); }
			if(tTC300 != 0.0001) { namJSON.put("T300_"+tFHour, tTC300); }
			if(tTC350 != 0.0001) { namJSON.put("T350_"+tFHour, tTC350); }
			if(tTC400 != 0.0001) { namJSON.put("T400_"+tFHour, tTC400); }
			if(tTC450 != 0.0001) { namJSON.put("T450_"+tFHour, tTC450); }
			if(tTC500 != 0.0001) { namJSON.put("T500_"+tFHour, tTC500); }
			if(tTC550 != 0.0001) { namJSON.put("T550_"+tFHour, tTC550); }
			if(tTC600 != 0.0001) { namJSON.put("T600_"+tFHour, tTC600); }
			if(tTC650 != 0.0001) { namJSON.put("T650_"+tFHour, tTC650); }
			if(tTC700 != 0.0001) { namJSON.put("T700_"+tFHour, tTC700); }
			if(tTC750 != 0.0001) { namJSON.put("T750_"+tFHour, tTC750); }
			if(tTC800 != 0.0001) { namJSON.put("T800_"+tFHour, tTC800); }
			if(tTC850 != 0.0001) { namJSON.put("T850_"+tFHour, tTC850); }
			if(tTC900 != 0.0001) { namJSON.put("T900_"+tFHour, tTC900); }
			if(tTC950 != 0.0001) { namJSON.put("T950_"+tFHour, tTC950); }
			if(tTC1000 != 0.0001) { namJSON.put("T1000_"+tFHour, tTC1000); }
			if(tTC0 != 0.0001) { namJSON.put("T0_"+tFHour, tTC0); }
			
			if(tTD100 != 0.0001) { namJSON.put("D100_"+tFHour, tTD100); }
			if(tTD150 != 0.0001) { namJSON.put("D150_"+tFHour, tTD150); }
			if(tTD200 != 0.0001) { namJSON.put("D200_"+tFHour, tTD200); }
			if(tTD250 != 0.0001) { namJSON.put("D250_"+tFHour, tTD250); }
			if(tTD300 != 0.0001) { namJSON.put("D300_"+tFHour, tTD300); }
			if(tTD350 != 0.0001) { namJSON.put("D350_"+tFHour, tTD350); }
			if(tTD400 != 0.0001) { namJSON.put("D400_"+tFHour, tTD400); }
			if(tTD450 != 0.0001) { namJSON.put("D450_"+tFHour, tTD450); }
			if(tTD500 != 0.0001) { namJSON.put("D500_"+tFHour, tTD500); }
			if(tTD550 != 0.0001) { namJSON.put("D550_"+tFHour, tTD550); }
			if(tTD600 != 0.0001) { namJSON.put("D600_"+tFHour, tTD600); }
			if(tTD650 != 0.0001) { namJSON.put("D650_"+tFHour, tTD650); }
			if(tTD700 != 0.0001) { namJSON.put("D700_"+tFHour, tTD700); }
			if(tTD750 != 0.0001) { namJSON.put("D750_"+tFHour, tTD750); }
			if(tTD800 != 0.0001) { namJSON.put("D800_"+tFHour, tTD800); }
			if(tTD850 != 0.0001) { namJSON.put("D850_"+tFHour, tTD850); }
			if(tTD900 != 0.0001) { namJSON.put("D900_"+tFHour, tTD900); }
			if(tTD950 != 0.0001) { namJSON.put("D950_"+tFHour, tTD950); }
			if(tTD1000 != 0.0001) { namJSON.put("D1000_"+tFHour, tTD1000); }
			if(tTD0 != 0.0001) { namJSON.put("D0_"+tFHour, tTD0); }
			
			if(tWD100 != 0.0001) { namJSON.put("WD100_"+tFHour, tWD100); }
			if(tWD150 != 0.0001) { namJSON.put("WD150_"+tFHour, tWD150); }
			if(tWD200 != 0.0001) { namJSON.put("WD200_"+tFHour, tWD200); }
			if(tWD250 != 0.0001) { namJSON.put("WD250_"+tFHour, tWD250); }
			if(tWD300 != 0.0001) { namJSON.put("WD300_"+tFHour, tWD300); }
			if(tWD350 != 0.0001) { namJSON.put("WD350_"+tFHour, tWD350); }
			if(tWD400 != 0.0001) { namJSON.put("WD400_"+tFHour, tWD400); }
			if(tWD450 != 0.0001) { namJSON.put("WD450_"+tFHour, tWD450); }
			if(tWD500 != 0.0001) { namJSON.put("WD500_"+tFHour, tWD500); }
			if(tWD550 != 0.0001) { namJSON.put("WD550_"+tFHour, tWD550); }
			if(tWD600 != 0.0001) { namJSON.put("WD600_"+tFHour, tWD600); }
			if(tWD650 != 0.0001) { namJSON.put("WD650_"+tFHour, tWD650); }
			if(tWD700 != 0.0001) { namJSON.put("WD700_"+tFHour, tWD700); }
			if(tWD750 != 0.0001) { namJSON.put("WD750_"+tFHour, tWD750); }
			if(tWD800 != 0.0001) { namJSON.put("WD800_"+tFHour, tWD800); }
			if(tWD850 != 0.0001) { namJSON.put("WD850_"+tFHour, tWD850); }
			if(tWD900 != 0.0001) { namJSON.put("WD900_"+tFHour, tWD900); }
			if(tWD950 != 0.0001) { namJSON.put("WD950_"+tFHour, tWD950); }
			if(tWD1000 != 0.0001) { namJSON.put("WD1000_"+tFHour, tWD1000); }
			if(tWD0 != 0.0001) { namJSON.put("WD0_"+tFHour, tWD0); }
			
			if(tWS100 != 0.0001) { namJSON.put("WS100_"+tFHour, tWS100); }
			if(tWS150 != 0.0001) { namJSON.put("WS150_"+tFHour, tWS150); }
			if(tWS200 != 0.0001) { namJSON.put("WS200_"+tFHour, tWS200); }
			if(tWS250 != 0.0001) { namJSON.put("WS250_"+tFHour, tWS250); }
			if(tWS300 != 0.0001) { namJSON.put("WS300_"+tFHour, tWS300); }
			if(tWS350 != 0.0001) { namJSON.put("WS350_"+tFHour, tWS350); }
			if(tWS400 != 0.0001) { namJSON.put("WS400_"+tFHour, tWS400); }
			if(tWS450 != 0.0001) { namJSON.put("WS450_"+tFHour, tWS450); }
			if(tWS500 != 0.0001) { namJSON.put("WS500_"+tFHour, tWS500); }
			if(tWS550 != 0.0001) { namJSON.put("WS550_"+tFHour, tWS550); }
			if(tWS600 != 0.0001) { namJSON.put("WS600_"+tFHour, tWS600); }
			if(tWS650 != 0.0001) { namJSON.put("WS650_"+tFHour, tWS650); }
			if(tWS700 != 0.0001) { namJSON.put("WS700_"+tFHour, tWS700); }
			if(tWS750 != 0.0001) { namJSON.put("WS750_"+tFHour, tWS750); }
			if(tWS800 != 0.0001) { namJSON.put("WS800_"+tFHour, tWS800); }
			if(tWS850 != 0.0001) { namJSON.put("WS850_"+tFHour, tWS850); }
			if(tWS900 != 0.0001) { namJSON.put("WS900_"+tFHour, tWS900); }
			if(tWS950 != 0.0001) { namJSON.put("WS950_"+tFHour, tWS950); }
			if(tWS1000 != 0.0001) { namJSON.put("WS1000_"+tFHour, tWS1000); }
			
			if(tWS0 != 0.0001) { namJSON.put("WS0_"+tFHour, tWS0); }
			if(tCIN != 0.0001) { namJSON.put("CIN_"+tFHour, tCIN); }
			if(tLI != 0.0001) { namJSON.put("LI_"+tFHour, tLI); }
			if(tPRATE != 0.0001) { namJSON.put("PRATE_"+tFHour, tPRATE*0.03937); }
		...
		String thisJSONstring = namJSON.toString();
