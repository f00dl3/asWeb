...
public class ModelWorkerHRWA {
	...
	public static void main(String[] args) {
		...
		final String hrwaBase= modelBeans.getNomadsBase()+"/hiresw/prod/hiresw."+getDate;
		...
		JSONObject hrwaJSON = new JSONObject();
		
		List<String> aFHList = new ArrayList<>();
		List<String> heightList = new ArrayList<>();
		
		
		try ( ResultSet resultSetAFH = mdb.q2rs1c(dbc, aFHq, null); ) { 
		...
		for (String tFHourStr : aFHList) {
			...
			File sounding = new File(xml2Path.getPath()+"/outHRWA_"+tFHour4D+".csv");
			File tFHGlob = new File(xml2Path.getPath()+"/fa"+tFHour4D);
			File tFHCtlFile = new File(tFHGlob.getPath()+".ctl");
			String tFHData = hrwaBase+"/hiresw.t"+getHour+"z.arw_5km.f"+tFHour2D+".conus.grib2";
			...
			Scanner hrwaScanner = null; try {		
				...
				while(hrwaScanner.hasNext()) {
					String line = hrwaScanner.nextLine();
			...
			if(tTC100 != 0.0001) { hrwaJSON.put("T100_"+tFHour, tTC100); }
			if(tTC150 != 0.0001) { hrwaJSON.put("T150_"+tFHour, tTC150); }
			if(tTC200 != 0.0001) { hrwaJSON.put("T200_"+tFHour, tTC200); }
			if(tTC250 != 0.0001) { hrwaJSON.put("T250_"+tFHour, tTC250); }
			if(tTC300 != 0.0001) { hrwaJSON.put("T300_"+tFHour, tTC300); }
			if(tTC350 != 0.0001) { hrwaJSON.put("T350_"+tFHour, tTC350); }
			if(tTC400 != 0.0001) { hrwaJSON.put("T400_"+tFHour, tTC400); }
			if(tTC450 != 0.0001) { hrwaJSON.put("T450_"+tFHour, tTC450); }
			if(tTC500 != 0.0001) { hrwaJSON.put("T500_"+tFHour, tTC500); }
			if(tTC550 != 0.0001) { hrwaJSON.put("T550_"+tFHour, tTC550); }
			if(tTC600 != 0.0001) { hrwaJSON.put("T600_"+tFHour, tTC600); }
			if(tTC650 != 0.0001) { hrwaJSON.put("T650_"+tFHour, tTC650); }
			if(tTC700 != 0.0001) { hrwaJSON.put("T700_"+tFHour, tTC700); }
			if(tTC750 != 0.0001) { hrwaJSON.put("T750_"+tFHour, tTC750); }
			if(tTC800 != 0.0001) { hrwaJSON.put("T800_"+tFHour, tTC800); }
			if(tTC850 != 0.0001) { hrwaJSON.put("T850_"+tFHour, tTC850); }
			if(tTC900 != 0.0001) { hrwaJSON.put("T900_"+tFHour, tTC900); }
			if(tTC950 != 0.0001) { hrwaJSON.put("T950_"+tFHour, tTC950); }
			if(tTC1000 != 0.0001) { hrwaJSON.put("T1000_"+tFHour, tTC1000); }
			if(tTC0 != 0.0001) { hrwaJSON.put("T0_"+tFHour, tTC0); }
			
			if(tTD100 != 0.0001) { hrwaJSON.put("D100_"+tFHour, tTD100); }
			if(tTD150 != 0.0001) { hrwaJSON.put("D150_"+tFHour, tTD150); }
			if(tTD200 != 0.0001) { hrwaJSON.put("D200_"+tFHour, tTD200); }
			if(tTD250 != 0.0001) { hrwaJSON.put("D250_"+tFHour, tTD250); }
			if(tTD300 != 0.0001) { hrwaJSON.put("D300_"+tFHour, tTD300); }
			if(tTD350 != 0.0001) { hrwaJSON.put("D350_"+tFHour, tTD350); }
			if(tTD400 != 0.0001) { hrwaJSON.put("D400_"+tFHour, tTD400); }
			if(tTD450 != 0.0001) { hrwaJSON.put("D450_"+tFHour, tTD450); }
			if(tTD500 != 0.0001) { hrwaJSON.put("D500_"+tFHour, tTD500); }
			if(tTD550 != 0.0001) { hrwaJSON.put("D550_"+tFHour, tTD550); }
			if(tTD600 != 0.0001) { hrwaJSON.put("D600_"+tFHour, tTD600); }
			if(tTD650 != 0.0001) { hrwaJSON.put("D650_"+tFHour, tTD650); }
			if(tTD700 != 0.0001) { hrwaJSON.put("D700_"+tFHour, tTD700); }
			if(tTD750 != 0.0001) { hrwaJSON.put("D750_"+tFHour, tTD750); }
			if(tTD800 != 0.0001) { hrwaJSON.put("D800_"+tFHour, tTD800); }
			if(tTD850 != 0.0001) { hrwaJSON.put("D850_"+tFHour, tTD850); }
			if(tTD900 != 0.0001) { hrwaJSON.put("D900_"+tFHour, tTD900); }
			if(tTD950 != 0.0001) { hrwaJSON.put("D950_"+tFHour, tTD950); }
			if(tTD1000 != 0.0001) { hrwaJSON.put("D1000_"+tFHour, tTD1000); }
			if(tTD0 != 0.0001) { hrwaJSON.put("D0_"+tFHour, tTD0); }
			
			if(tWD100 != 0.0001) { hrwaJSON.put("WD100_"+tFHour, tWD100); }
			if(tWD150 != 0.0001) { hrwaJSON.put("WD150_"+tFHour, tWD150); }
			if(tWD200 != 0.0001) { hrwaJSON.put("WD200_"+tFHour, tWD200); }
			if(tWD250 != 0.0001) { hrwaJSON.put("WD250_"+tFHour, tWD250); }
			if(tWD300 != 0.0001) { hrwaJSON.put("WD300_"+tFHour, tWD300); }
			if(tWD350 != 0.0001) { hrwaJSON.put("WD350_"+tFHour, tWD350); }
			if(tWD400 != 0.0001) { hrwaJSON.put("WD400_"+tFHour, tWD400); }
			if(tWD450 != 0.0001) { hrwaJSON.put("WD450_"+tFHour, tWD450); }
			if(tWD500 != 0.0001) { hrwaJSON.put("WD500_"+tFHour, tWD500); }
			if(tWD550 != 0.0001) { hrwaJSON.put("WD550_"+tFHour, tWD550); }
			if(tWD600 != 0.0001) { hrwaJSON.put("WD600_"+tFHour, tWD600); }
			if(tWD650 != 0.0001) { hrwaJSON.put("WD650_"+tFHour, tWD650); }
			if(tWD700 != 0.0001) { hrwaJSON.put("WD700_"+tFHour, tWD700); }
			if(tWD750 != 0.0001) { hrwaJSON.put("WD750_"+tFHour, tWD750); }
			if(tWD800 != 0.0001) { hrwaJSON.put("WD800_"+tFHour, tWD800); }
			if(tWD850 != 0.0001) { hrwaJSON.put("WD850_"+tFHour, tWD850); }
			if(tWD900 != 0.0001) { hrwaJSON.put("WD900_"+tFHour, tWD900); }
			if(tWD950 != 0.0001) { hrwaJSON.put("WD950_"+tFHour, tWD950); }
			if(tWD1000 != 0.0001) { hrwaJSON.put("WD1000_"+tFHour, tWD1000); }
			if(tWD0 != 0.0001) { hrwaJSON.put("WD0_"+tFHour, tWD0); }
			
			if(tWS100 != 0.0001) { hrwaJSON.put("WS100_"+tFHour, tWS100); }
			if(tWS150 != 0.0001) { hrwaJSON.put("WS150_"+tFHour, tWS150); }
			if(tWS200 != 0.0001) { hrwaJSON.put("WS200_"+tFHour, tWS200); }
			if(tWS250 != 0.0001) { hrwaJSON.put("WS250_"+tFHour, tWS250); }
			if(tWS300 != 0.0001) { hrwaJSON.put("WS300_"+tFHour, tWS300); }
			if(tWS350 != 0.0001) { hrwaJSON.put("WS350_"+tFHour, tWS350); }
			if(tWS400 != 0.0001) { hrwaJSON.put("WS400_"+tFHour, tWS400); }
			if(tWS450 != 0.0001) { hrwaJSON.put("WS450_"+tFHour, tWS450); }
			if(tWS500 != 0.0001) { hrwaJSON.put("WS500_"+tFHour, tWS500); }
			if(tWS550 != 0.0001) { hrwaJSON.put("WS550_"+tFHour, tWS550); }
			if(tWS600 != 0.0001) { hrwaJSON.put("WS600_"+tFHour, tWS600); }
			if(tWS650 != 0.0001) { hrwaJSON.put("WS650_"+tFHour, tWS650); }
			if(tWS700 != 0.0001) { hrwaJSON.put("WS700_"+tFHour, tWS700); }
			if(tWS750 != 0.0001) { hrwaJSON.put("WS750_"+tFHour, tWS750); }
			if(tWS800 != 0.0001) { hrwaJSON.put("WS800_"+tFHour, tWS800); }
			if(tWS850 != 0.0001) { hrwaJSON.put("WS850_"+tFHour, tWS850); }
			if(tWS900 != 0.0001) { hrwaJSON.put("WS900_"+tFHour, tWS900); }
			if(tWS950 != 0.0001) { hrwaJSON.put("WS950_"+tFHour, tWS950); }
			if(tWS1000 != 0.0001) { hrwaJSON.put("WS1000_"+tFHour, tWS1000); }
			if(tWS0 != 0.0001) { hrwaJSON.put("WS0_"+tFHour, tWS0); }

			if(tCIN != 0.0001) { hrwaJSON.put("CIN_"+tFHour, tCIN); }
			if(tLI != 0.0001) { hrwaJSON.put("LI_"+tFHour, tLI); }
			if(tPRATE != 0.0001) { hrwaJSON.put("PRATE_"+tFHour, tPRATE*0.03937); }
			if(tPWAT != 0.0001) { hrwaJSON.put("PWAT_"+tFHour, tPRATE*0.03937); }
			if(tHGT500 != 0.0001) { hrwaJSON.put("HGT500_"+tFHour, tHGT500); }
		...
		String thisJSONstring = hrwaJSON.toString();
