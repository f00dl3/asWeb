/*
SNMP Walk  Raspberry Pi 3 class
created: 5 Mar 2020
updated: on cretaion
 */
...
public class Pi3 {
    ...
    public void snmpPi3(Connection dbc) {

        	CommonBeans cb = new CommonBeans();
            WebCommon wc = new WebCommon();
            
            final String ramPath = cb.getPathChartCache();
            final String ramPathUnzipped = ramPath + "/snmpUnzip/Pi3";
            final File piSnmpZip = new File(ramPath+"/snmpPi3.zip");
            ...
            wc.runProcess("mv "+ramPathUnzipped+"/dev/shm/snmpPi3/* "+ramPathUnzipped);

            final File pi3WalkFile = new File(ramPathUnzipped+"/snmpwalkPi3.txt");
            final File pioSerialMonFile3 = new File(ramPathUnzipped+"/pioSerialMon3.log");
            ...
            Scanner pi2WalkFileScanner = null; try {		
                    pi2WalkFileScanner = new Scanner(pi3WalkFile);
            ...
            try { wc.sedFileReplace(pioSerialMonFile3.getPath(), "\\n\\n", "\n"); } catch (Exception e) { }
            ...
            try {
                    FileInputStream inSerialMon = new FileInputStream(pioSerialMonFile3);
            ...
            String pi3SQLQuery = "INSERT IGNORE INTO net_snmp.RaspberryPi3 ("
            ...
            System.out.println(pi3SQLQuery);

            try { pioSerialMonFile3.delete(); } catch (Exception e) { }

            try { wc.q2do1c(dbc, pi3SQLQuery, null); } catch (Exception e) { e.printStackTrace(); }
