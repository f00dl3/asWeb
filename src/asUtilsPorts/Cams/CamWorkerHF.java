...
public class CamWorkerHF {
	...
	public void main(String camPath, String instance) {
        ...
        while (testVal == testVal) {
			...
			String convertA = "convert \\( "+webC4File.getPath()+" -resize "+capRes+"! "+webC1File.getPath()+" -resize "+capRes+"! "+webC6File.getPath()+" -resize "+capRes+"! +append \\)"
