/*
by Anthony Stump
Models 2019 core class Tomcat Port
...
import asUtilsPorts.Weather.ModelWorker_19;

public class Models19 {
	...
	public static void main(String[] args) {
		...
		Thread mw01 = new Thread(() -> { ModelWorker_19.main(mw01Args); });
		Thread mw02 = new Thread(() -> { ModelWorker_19.main(mw02Args); });
		Thread mw03 = new Thread(() -> { ModelWorker_19.main(mw03Args); });
		Thread mw04 = new Thread(() -> { ModelWorker_19.main(mw04Args); });
		Thread mw05 = new Thread(() -> { ModelWorker_19.main(mw05Args); });
		Thread mw06 = new Thread(() -> { ModelWorker_19.main(mw06Args); });
		Thread mw07 = new Thread(() -> { ModelWorker_19.main(mw07Args); });
		Thread mw08 = new Thread(() -> { ModelWorker_19.main(mw08Args); });
		Thread mw09 = new Thread(() -> { ModelWorker_19.main(mw09Args); });
		Thread mw10 = new Thread(() -> { ModelWorker_19.main(mw10Args); });
		Thread mw11 = new Thread(() -> { ModelWorker_19.main(mw11Args); });
		Thread mw12 = new Thread(() -> { ModelWorker_19.main(mw12Args); });
		Thread mw13 = new Thread(() -> { ModelWorker_19.main(mw13Args); });
		Thread mw14 = new Thread(() -> { ModelWorker_19.main(mw14Args); });
		Thread mw15 = new Thread(() -> { ModelWorker_19.main(mw15Args); });
		Thread mw16 = new Thread(() -> { ModelWorker_19.main(mw16Args); });
		Thread mw17 = new Thread(() -> { ModelWorker_19.main(mw17Args); });
		Thread mw18 = new Thread(() -> { ModelWorker_19.main(mw18Args); });
		Thread mw19 = new Thread(() -> { ModelWorker_19.main(mw19Args); });
		Thread mw20 = new Thread(() -> { ModelWorker_19.main(mw20Args); });
		Thread mw21 = new Thread(() -> { ModelWorker_19.main(mw21Args); });
		Thread mw22 = new Thread(() -> { ModelWorker_19.main(mw22Args); });
		Thread mw23 = new Thread(() -> { ModelWorker_19.main(mw23Args); });
		Thread mw24 = new Thread(() -> { ModelWorker_19.main(mw24Args); });
		Thread mw25 = new Thread(() -> { ModelWorker_19.main(mw25Args); });
		Thread mw26 = new Thread(() -> { ModelWorker_19.main(mw26Args); });
		Thread mw27 = new Thread(() -> { ModelWorker_19.main(mw27Args); });
		...
		try { mdb.q2do1c(dbc, mSQLIndex, null); } catch (Exception e) { e.printStackTrace(); }
		try { mdb.q2do1c(dbc, mSQLQuery, null); } catch (Exception e) { e.printStackTrace(); }
